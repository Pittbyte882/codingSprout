...
export const metadata: Metadata = {
  title: "Donate | Coding Sprout",
  description: "Support Coding Sprout's mission to make coding education accessible to all children.",
}
      ...
      <section className="bg-gradient-to-br from-off-white to-warm-yellow/10 py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-secondary sm:text-5xl">Support Our Mission</h1>
      ...
      <section className="bg-secondary py-16 lg:py-24">
        <div className="mx-auto max-w-3xl px-4 text-center lg:px-8">
          ...
          <p className="mt-4 text-secondary-foreground/80">
            Coding Sprout is a community organization dedicated to making coding education accessible to all. Your
            generous donation helps us continue this important work.
          </p>
          <div className="mt-8">
          ...
          <p className="mt-6 text-sm text-secondary-foreground/60">
            For questions about donations, please contact us at hello@codingsprout.com
          </p>
        </div>
      </section>
    </div>
